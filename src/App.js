    ...
    <div className="app">
      ...
      <div className='container'>
        ...
        <div className='button_collection'>
          ...
          <Button type='submit' className='btn_one' style={{backgroundColor: 'blue'}} variant="contained">Calculate</Button>
          <Button className='btn_one' onClick={handleClick} style={{backgroundColor: 'blue'}} variant="contained">Reset</Button>
          </Stack>
        </div>
        </div>
        </form>
